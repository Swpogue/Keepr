      ...
      <form @submit.prevent="createKeep()">
        <div class="row modal-body">
          <div class="col-12">
            ...
            <input type="text" id="keepName" name="keepName" class="form-control" required minlength="5" maxlength="25" aria-label="Keep Name" v-model="editable.name">
          </div>
          <div class="col-12">
          ...
          <div class="col-12">
            ...
            <input type="text" name="description" id="description" class="form-control" aria-label="Description" required minlength="5" maxlength="500" v-model="editable.description">
          </div>
        </div>
